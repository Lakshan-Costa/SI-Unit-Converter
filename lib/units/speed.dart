...
import 'package:si_unit_app/valueTables/speedvalue.dart';
...
class _SpeedPageState extends State<SpeedPage> {
  ...
  String _val1 = "Miles per hour";
  String _val2 = "Miles per hour";
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              items: <DropdownMenuItem<String>>[
                                DropdownMenuItem(child: Text("Miles per hour"), value: "Miles per hour", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Foot per second"), value: "Foot per second", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Meter per second"), value: "Meter per second", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Kilometer per hour"), value: "Kilometer per hour", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Knot"), value: "Knot", onTap: () {
                                  _val1 = _val1;
                                },),
