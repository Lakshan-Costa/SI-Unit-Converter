...
import 'package:si_unit_app/valueTables/energyvalue.dart';
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              items: <DropdownMenuItem<String>>[
                                DropdownMenuItem(child: Text("Joule"), value: "Joule", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Kilojoule"), value: "Kilojoule", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Gram calorie"), value: "Gram calorie", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Kilocalorie"), value: "Kilocalorie", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Watt hour"), value: "Watt hour", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Kilowatt hour"), value: "Kilowatt hour", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Electronvolt"), value: "Electronvolt", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("British thermal unit",), value: "British thermal unit", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("US therm"), value: "US therm", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Foot-pound"), value: "Foot-pound", onTap: () {
                                  _val1 = _val1;
                                },),
                              ],
                              onChanged: (value) {
