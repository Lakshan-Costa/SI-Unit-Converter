...
import 'package:si_unit_app/valueTables/timevalue.dart';
...
class _TimePageState extends State<TimePage> {
  ...
  String _val1 = "Nanosecond";
  String _val2 = "Nanosecond";
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              items: <DropdownMenuItem<String>>[
                                DropdownMenuItem(child: Text("Nanosecond"), value: "Nanosecond", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Microsecond"), value: "Microsecond", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Millisecond"), value: "Millisecond", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Second"), value: "Second", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Minute"), value: "Minute", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Hour"), value: "Hour", onTap: () {
                                  _val1 = _val1;
                                },),
                                ...
                                DropdownMenuItem(child: Text("Decade"), value: "Decade", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Century"), value: "Century", onTap: () {
                                  _val1 = _val1;
                                },),
                              ],
                              onChanged: (value) {
