...
import 'package:si_unit_app/valueTables/lengthvalue.dart';
...
class _LengthPageState extends State<LengthPage> {
  ...
  String _val1 = "Kilometer";
  String _val2 = "Kilometer";
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              items: <DropdownMenuItem<String>>[
                                DropdownMenuItem(child: Text("Kilometer"), value: "Kilometer", onTap: () {
                                  _val1 = _val1;



                                },),
                                DropdownMenuItem(child: Text("Meter"), value: "Meter", onTap: () async {
                                  _val1 = _val1;

                                },),

                                DropdownMenuItem(child: Text("Centimeter"), value: "Centimeter", onTap: () async {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Millimeter"), value: "Millimeter", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Micrometer"), value: "Micrometer", onTap: () {
                                  _val1 = _val1;

                                },),
                                DropdownMenuItem(child: Text("Nanometer"), value: "Nanometer", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Mile"), value: "Mile", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Yard"), value: "Yard", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Foot"), value: "Foot", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Inch"), value: "Inch", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Nautical mile"), value: "Nautical mile", onTap: () {
                                  _val1 = _val1;
                                },),
                              ],
                              onChanged: (value) {
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              items: <DropdownMenuItem<String>>[
                                ...
                                DropdownMenuItem(child: Text("Meter"), value: "Meter", onTap: () {
                                  _val2 = _val2;
                                },),

                                DropdownMenuItem(child: Text("Centimeter"), value: "Centimeter", onTap: () {
                                  _val2 = _val2;
