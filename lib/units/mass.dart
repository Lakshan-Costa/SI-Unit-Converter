...
import 'package:si_unit_app/valueTables/massvalue.dart';
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              items: <DropdownMenuItem<String>>[
                                DropdownMenuItem(child: Text("tonne"), value: "tonne", onTap: () {
                                  _val1 = _val1;
                                ...
                                DropdownMenuItem(child: Text("Milligram"), value: "Milligram", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Microgram"), value: "Microgram", onTap: () {
                                  _val1 = _val1;

                                },),
                                DropdownMenuItem(child: Text("Imperial ton"), value: "Imperial ton", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("US ton"), value: "US ton", onTap: () {
                                  _val1 = _val1;

                                },),
                                DropdownMenuItem(child: Text("Stone"), value: "Stone", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Pound"), value: "Pound", onTap: () {
                                  _val1 = _val1;

                                },),
                                DropdownMenuItem(child: Text("Ounce"), value: "Ounce", onTap: () {
                                  _val1 = _val1;
                                },),
                              ],
                              onChanged: (value) {
