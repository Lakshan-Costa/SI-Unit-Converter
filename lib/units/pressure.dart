...
import 'package:si_unit_app/valueTables/pressurevalue.dart';
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              items: <DropdownMenuItem<String>>[
                                DropdownMenuItem(child: Text("Bar"), value: "Bar", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Pascal"), value: "Pascal", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Pound per square inch", style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal*3.5)), value: "Pound per square inch", onTap: () {
                                  _val1 = _val1;


                                },),
                                DropdownMenuItem(child: Text("Standard atmosphere", style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal*3.6)), value: "Standard atmosphere", onTap: () {
                                  _val1 = _val1;
                                },),

                                DropdownMenuItem(child: Text("Torr"), value: "Torr", onTap: () {
                                  _val1 = _val1;
